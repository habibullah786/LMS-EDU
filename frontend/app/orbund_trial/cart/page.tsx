...
export default function OrbundCartPage() {
  ...
  useEffect(() => {
    const raw = sessionStorage.getItem('orbund_cart');
    if (!raw) { router.replace('/orbund_trial/classes'); return; }
    ...
    <div className="min-h-screen bg-gradient-to-br from-blue-50 to-indigo-100 flex items-center justify-center p-4">
      <div className="bg-white rounded-2xl shadow-xl w-full max-w-lg p-8">
        <div className="text-center mb-6">
          ...
          <p className="text-gray-500 mt-1">Step 3 of 6 — Confirm your selections</p>
        </div>
        ...
        {loading ? (
          ...
          <>
            ...
            <div className="flex gap-3">
              <button
                onClick={() => router.push('/orbund_trial/classes')}
                className="flex-1 border border-gray-300 text-gray-700 py-3 rounded-lg hover:bg-gray-50"
              >
                ← Back
              </button>
              <button
                onClick={() => router.push('/orbund_trial/login')}
